...
function bristles_scripts() {
	...
	wp_enqueue_style( 'bristles-jqm', '//ajax.googleapis.com/ajax/libs/jquerymobile/1.4.5/jquery.mobile.min.css' );

	wp_enqueue_script( 'jquery' );
	wp_enqueue_script( 'jquery-mobile', '//ajax.googleapis.com/ajax/libs/jquerymobile/1.4.5/jquery.mobile.min.js' );
	wp_enqueue_script( 'bristles-navigation', get_template_directory_uri() . '/js/navigation.js', '', '', true );
	wp_enqueue_script( 'bristle0js', get_template_directory_uri() . '/js/custom.js', '', '', true );
}
